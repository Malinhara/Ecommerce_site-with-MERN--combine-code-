...
const sendData = async () => {
  try {
    ...
    const response = await axios.delete(`http://localhost:3001/product/delete/${formData.productid}`, {
    headers: {
  ...
  return (
    ...
    <center> <form onSubmit={handleSubmit}>
      ...
      >
        ...
        <Button variant='primary' type="submit" className='custom-button8' >Delete Product</Button>
    </form></center><br></br>
